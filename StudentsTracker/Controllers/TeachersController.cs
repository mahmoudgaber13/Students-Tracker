...
namespace StudentsTracker.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Name,BirthDate")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Name,BirthDate")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
